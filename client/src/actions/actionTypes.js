export default {
  ...
  AUTH_ACTION_RESET_MAIL: 'AUTH_ACTION_RESET_MAIL',
  AUTH_ACTION_RESET: 'AUTH_ACTION_RESET',
  AUTH_ACTION_RESET_SUCCESS: 'AUTH_ACTION_RESET_SUCCESS',
  AUTH_ACTION_RESET_ERROR: 'AUTH_ACTION_RESET_ERROR',
  AUTH_ACTION_RESET_SEND_SUCCESS: 'AUTH_ACTION_RESET_SEND_SUCCESS',
  AUTH_ACTION_RESET_SEND_ERROR: 'AUTH_ACTION_RESET_SEND_ERROR',
  ...
  CHECK_EVENTS_REQUEST: 'CHECK_EVENTS_REQUEST',
  CHECK_EVENTS_SUCCESS: 'CHECK_EVENTS_SUCCESS',
  CHECK_EVENTS_ERROR: 'CHECK_EVENTS_ERROR',
  SORT_EVENTS: 'SORT_EVENTS',
  SORT_EVENTS_REQUEST: 'SORT_EVENTS_REQUEST',
  SORT_EVENTS_SUCCESS: 'SORT_EVENTS_SUCCESS',
  SORT_EVENTS_ERROR: 'SORT_EVENTS_ERROR',
  EVENT_CLEAR_ERROR: 'EVENT_CLEAR_ERROR',
  CLEAR_EVENTS: 'CLEAR_EVENTS',
  CLEAR_EVENTS_REQUEST: 'CLEAR_EVENTS_REQUEST',
  CLEAR_EVENTS_SUCCESS: 'CLEAR_EVENTS_SUCCESS',
  ...
  MODERATOR_OFFER_UPDATE: 'MODERATOR_OFFER_UPDATE',
  MODERATOR_UPDATE_OFFER_REQUEST: 'MODERATOR_UPDATE_OFFER_REQUEST',
  MODERATOR_UPDATE_OFFER_SUCCESS: 'MODERATOR_UPDATE_OFFER_SUCCESS',
  MODERATOR_UPDATE_OFFER_ERROR: 'MODERATOR_UPDATE_OFFER_ERROR',
