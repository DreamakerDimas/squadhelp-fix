            ...
            <Col sm={9}>
              <Tab.Content>
                  ...
                  <Accordion>
                    ...
                    <Card>
                      ...
                      <Accordion.Collapse eventKey="1">
                        <Card.Body>
                          ...
                          Trademark Research, both will be an additional 4-7
                          days (3-5 business days for Audience Testing and 1-2
                          business days for Trademark Research).
                        </Card.Body>
                      </Accordion.Collapse>
                    </Card>
                    ...
                    <Card>
                      ...
                      <Accordion.Collapse eventKey="2">
                        <Card.Body>
                          ...
                          States and other English speaking countries (i.e.
                          United Kingdom, Canada, and Australia.). We utilize an
                          advanced rating score algorithm to ensure that high
                          quality creatives receive more opportunities to
                        ...
                        <Card.Body>
                          ...
                          <ul className={styles.markedList}>
                            <li>
                              ...
                              well as a complimentary consultation with one of
                              our branding consultants (a $99 value).
                            </li>
                            <li>
                              By exploring our premium domain marketplace you
                              can apply the contest award towards the purchase
                              of any name listed for sale.
                            </li>
                            <li>
                              ...
                              forward with any name from you project. (Please
                              note that the refund is for the contest award).
                    ...
                    <Card>
                      ...
                      <Accordion.Collapse eventKey="4">
                        <Card.Body>
                          ...
                          design competitions start at $299. Also, there are
                          three additional contest level that each offer more
                          features and benefits. See our Pricing Page for
                          details.
                        </Card.Body>
                      </Accordion.Collapse>
                    </Card>
                    ...
                    <Card>
                      <Card.Header className="accordion-header">
                        <Accordion.Toggle
                          ...
                          eventKey="5"
                        >
                          I need both a Name and a Logo. Do you offer any
                          discount for multiple contests?
                        </Accordion.Toggle>
                      </Card.Header>
                      <Accordion.Collapse eventKey="5">
                        <Card.Body>
                          Yes! We have many contest bundles - our most popular
                          being our Name, Tagline, and Logo bundle. Bundles
                          allow you to purchase multiple contests at one time
                          and save as much as from $75 - $400. You can learn
                          more about our bundle options on our{' '}
                          <a href="https://www.google.com" target="_blank">
                            Pricing Page
                          </a>
                        </Card.Body>
                    ...
                    <Card>
                      ...
                      <Accordion.Collapse eventKey="6">
                        <Card.Body>
                          ...
                          ensure that only those contestants who agree to the
                          NDA will be able to read your project brief and
                          participate in the contest. The contest details will
                          be kept private from other users, as well as search
                          engines.
                        </Card.Body>
                      </Accordion.Collapse>
                    </Card>
                    ...
                    <Card>
                      ...
                      <Accordion.Collapse eventKey="7">
                        <Card.Body>
                          Absolutely. Squadhelp services organizations across
                          the globe. Our customer come from many countries, such
                          as the United States, Australia, Canada, Europe,
                          India, and MENA. We’ve helped more than 25,000
                ...
                <Tab.Pane eventKey="buyingFromMarketplace">
                  <h2 className={styles.tabPaneTitle}>
                    Buying From Marketplace
                  </h2>
                  <Accordion>
                    <Card>
                      ...
                      <Accordion.Collapse eventKey="9">
                        <Card.Body>
                          ...
                          marketplace, you will receive the exact match .com
                          URL, a complimentary logo design (along with all
                          source files), as well as a complimentary Trademark
                          report and Audience Testing if you’re interested in
                    ...
                    <Card>
                      ...
                      <Accordion.Collapse eventKey="11">
                        <Card.Body>
                          ...
                          Marketplace. If you purchase a domain on a payment
                          plan, we hold the domain in an Escrow account until it
                          is fully paid off. However our team can assist you
                          with making any changes to the domains (such as
                          Nameserver changes), so that you can start using the
                          domain right away after making your first installment
                          payment.
                        </Card.Body>
                      </Accordion.Collapse>
                    </Card>
                    ...
                    <Card>
                      ...
                      <Accordion.Collapse eventKey="12">
                        <Card.Body>
                          ...
                          experience and they do not want to manage the contest
                          directly. Our branding team has directly managed
                          hundreds of branding projects and has learned several
                          best practices that lead to successful project
                          outcomes. Our team will apply all best practices
                          towards the management of your branding project. Learn
                          more about our{' '}
                          <a href="https://www.google.com" target="_blank">
                        ...
                        <Card.Body>
                          ...
                          <ul className={styles.markedList}>
                            <li>
                              ...
                              call with your Branding Consultant. You can
                              schedule this call online immediately after making
                              your payment.
                            </li>
                            <li>
                    ...
                    <Card>
                      ...
                      <Accordion.Collapse eventKey="14">
                        <Card.Body>
                          ...
                          ($999) and Enterprise ($1999). The Enterprise managed
                          contest includes:
                          <ul className={styles.markedList}>
                            <li>
                            ...
                            <li>
                              (3) you will receive more high-end trademark
                              report and 5X more responses for your audience
                              test.
                            </li>
                            <li>
                              Here is a link to our{' '}
                    ...
                    <Card>
                      ...
                      <Accordion.Collapse eventKey="15">
                        <Card.Body>
                          ...
                          hundreds of branding projects for companies ranging
                          from early stage startups to Fortune 500 corporations.
                        </Card.Body>
                      </Accordion.Collapse>
                    </Card>
                  </Accordion>
                  ...
                  <Accordion>
                    <Card>
                      ...
                      <Accordion.Collapse eventKey="16">
                        <Card.Body>
                          ...
                          participate in the platform. On the other hand, we
                          limit the participation from those creatives who do
                          not consistently receive high ratings.
                        </Card.Body>
                      </Accordion.Collapse>
                    </Card>
                    ...
                    <Card>
                      ...
                      <Accordion.Collapse eventKey="17">
                        <Card.Body>
                          When you initially signup, you are assigned few
                          contests to assess your overall quality of
                          submissions. Based upon the quality of your
                          submissions, you will continue to be assigned
                          additional contests. Once you have received enough
